 ...
 * 
 */
package com.salvador.thiago.taskManagerApiRest.util;
...
public class ObjectMapperUtils {
	...
	public static <D, T> Page<D> mapAllPage(Page<T> entityListPage, Class<D> outCLass) {
		return (Page<D>) entityListPage.stream()
                .map(entity -> map(entity, outCLass))
                .collect(Collectors.toList());
	}
